(function ($)
{
	...
	jqueryUtil.chgSkin=function(selectId,cookiesColor){
            ...
            function docchgskin(dc,selectId,cookiesColor){
            	        var cssPath = "/js/framework/jquery-easyui-1.3.6/themes/";
//            	        cssPath = "/css/themes/"
            	        var path = getContextPath();
					  removejscssfile(dc,path+cssPath+cookiesColor+"/easyui.css", "css");
                      createLink(dc,path+cssPath+selectId+"/easyui.css");
        	}
	...
	,{
		...
		value : 'icon-meetingumag',
		text : 'icon-meetingumag'
	},{
		value : 'icon-useroff',
		text : 'icon-useroff'
	},{
		...
		value : 'icon-icon2_2ye',
		text : 'icon-icon2_2ye'
	},{
		value : 'icon-icon3_2ye',
		text : 'icon-icon3_2ye'
	},{
		value : 'icon-icon4_2ye',
		text : 'icon-icon4_2ye'
	},{
		value : 'icon-icon5_2ye',
		text : 'icon-icon5_2ye'
	},{
		value : 'icon-icon6_2ye',
		text : 'icon-icon6_2ye'
	},{
		value : 'icon-icon7_2ye',
		text : 'icon-icon7_2ye'
	},{
		value : 'icon-icon13_2ye',
		text : 'icon-icon13_2ye'
	}
	];
})(jQuery);